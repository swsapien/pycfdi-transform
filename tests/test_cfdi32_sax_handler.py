...
class TestCFDI32SAXHandler(unittest.TestCase):
    ...
    def test_transform_file(self):
        sax_handler = CFDI32SAXHandler()
        cfdi_data = sax_handler.transform_from_file("./Resources/cfdi32/cfdi32_01.xml")
    ...
    def test_transform_file_utf8chars(self):
        sax_handler = CFDI32SAXHandler().use_concepts_cfdi33()
    ...
    def test_transform_file_with_concepts(self):
        ...
        cfdi_data = sax_handler.transform_from_file("./tests/Resources/cfdi33/cfdi32_01.xml")
        self.assertIsNotNone(cfdi_data)
        expected_dict = {
            'cfdi33': {
                'version': '3.3',
    ...
    def test_transform_file_with_concepts_bad_description(self):
        sax_handler = CFDI32SAXHandler(esc_delimiters="~").use_concepts_cfdi33()
