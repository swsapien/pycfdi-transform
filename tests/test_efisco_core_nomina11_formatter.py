...
class TestEfiscoNomina11Formatter(unittest.TestCase):
    ...
    def test_columns_names_nomina11(self):
        formatter = EfiscoCoreNomina11Formatter({'cfdi32': {}})
        columns_expected = [
            'VERSION',
            'SERIE',
            'FOLIO',
    ...
    def test_initialize_class_error_nomina11(self):
        with self.assertRaises(AssertionError) as ex:
            EfiscoCoreNomina11Formatter(cfdi_data=None)
    ...
    def test_initialize_class_error_version_nomina11(self):
        with self.assertRaises(AssertionError) as ex:
            EfiscoCoreNomina11Formatter({'cfdi33': {}})
    ...
    def test_formatter_rows_nom_complete(self):
        ...
        sax_handler = CFDI32SAXHandler().use_nomina11()
        cfdi_data = sax_handler.transform_from_file(os.path.dirname(__file__) + '/Resources/nomina11/nom_complete.xml')
        expected_columns = [['3.2', 'A', '1', '2015-03-05T10:33:48', '20001000000100005867', '35000.00', '0.00', '40600.00', 'Pesos', '', 'egreso', 'No Identificado', 'PAGO EN UNA SOLA EXHIBICION', '', 'Zapopan, Jalisco', 'AAA010101AAA', 'Empresa de Pruebas SA DE CV', 'Regimen General de Ley Personas Morales de Prueba', 'CACX7605101P8', 'EMPLEADO DE PRUEBA', '', 'CD13D35E-2FCF-4A23-ADCA-51F2E48B8018', '2014-04-03T18:17:02', '', 'MUIy85bMjr2K7CLZcj1PnUU3a56KmrqOvF7ubEnaa0beidmPqi7S0YVznA5EKs76c4sJFBGhR73WA47RVNqUFbGdWrd43Mv326SJ+4eRAiJ/2AzAdMX742cxiZ76K9FavCz9sRYkHJLvRkAOk8JewVRWGglEnJLReBr4SX/zGfg=', '', '2013-11-15', '2014-11-01', '2014-11-15', '15', '', '', '', '', 'A0000000000', '', 'XEXX010101HNEXXXA4', '00000000000', '2009-06-01', '', 'Diurna', '1', '9872', 'DPTO', 'ADMIN', '1', '113', '000000000000000000', '228', 'Base', 'Quincenal', '10000.00', '696.80', '', '', '', '', '13000.00', '379.00', '001', '0.00', '10000.00', '002', '0.00', '1000.00', '', '', '', '004', '0.00', '1000.00', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '019', '0.00', '1000.00', '2', 'Dobles', '3', '2653.42', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '029', '379.00', '0.00', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '3332.1', '0.00', '001', '278.39', '002', '2053.71', '', '', '', '', '', '', '', '', '300.00', '1', '2', '007', '0.00', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '020', '1000.00', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '']]
        formatter = EfiscoCoreNomina11Formatter(cfdi_data)
    ...
    def test_formatter_compatibility_legacy_version_01_ok(self):
        sax_handler = CFDI32SAXHandler().use_nomina11()
        cfdi_data = sax_handler.transform_from_file(os.path.dirname(__file__) + '/Resources/nomina11/nomina11_efisco_core_formatter_legacy_01.xml')
        expected_columns_length = 440
        expected_columns = [['3.2', 'A', '1', '2015-03-05T10:33:48', '20001000000100005867', '35000.00', '0.00', '40600.00', 'Pesos', '1.00', 'egreso', 'No Identificado', 'PAGO EN UNA SOLA EXHIBICION', '-', 'Zapopan, Jalisco', 'MISC491214B86', 'Empresa de Pruebas SA DE CV', 'Regimen General de Ley Personas Morales de Prueba', 'CACX7605101P8', 'EMPLEADO DE PRUEBA', '-', 'CD13D35E-2FCF-4A23-ADCA-51F2E48B8018', '2014-04-03T18:17:02', '-', 'MUIy85bMjr2K7CLZcj1PnUU3a56KmrqOvF7ubEnaa0beidmPqi7S0YVznA5EKs76c4sJFBGhR73WA47RVNqUFbGdWrd43Mv326SJ+4eRAiJ/2AzAdMX742cxiZ76K9FavCz9sRYkHJLvRkAOk8JewVRWGglEnJLReBr4SX/zGfg=', '-', '2013-11-15', '2014-11-01', '2014-11-15', '15', '0.00', '0.00', '0.00', '0.00', 'A0000000000', '-', 'XEXX010101HNEXXXA4', '00000000000', '2009-06-01', '-', 'Diurna', '1', '9872', 'DPTO', 'ADMIN', '1', '113', '000000000000000000', '228', 'Base', 'Quincenal', '10000.00', '696.80', '-', '0.00', '0.00', '0.00', '13000.00', '379.00', '001', '0.00', '10000.00', '002', '0.00', '1000.00', '-', '-', '-', '004', '0.00', '1000.00', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '019', '0.00', '1000.00', '2', 'Dobles', '3', '2653.42', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '029', '379.00', '0.00', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '3332.1', '0.00', '001', '278.39', '002', '2053.71', '-', '-', '-', '-', '-', '-', '-', '-', '300.00', '1', '2', '007', '0.00', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '020', '1000.00', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-']]
        formatter = EfiscoCoreNomina11Formatter(cfdi_data, empty_char='-', safe_numerics=True)
        result_columns = formatter.dict_to_columns()
    ...
    def test_formatter_compatibility_legacy_version_02_ok(self):
        sax_handler = CFDI32SAXHandler().use_nomina11()
        cfdi_data = sax_handler.transform_from_file(os.path.dirname(__file__) + '/Resources/nomina11/nomina11_efisco_core_formatter_legacy_02.xml')
        expected_columns_length = 440
        expected_columns = [['3.2', 'A', '1', '2015-03-05T10:33:48', '20001000000100005867', '35000.00', '0.00', '40600.00', 'Pesos', '1.00', 'egreso', 'No Identificado', 'PAGO EN UNA SOLA EXHIBICION', '-', 'Zapopan, Jalisco', 'MISC491214B86', 'Empresa de Pruebas SA DE CV', 'Regimen General de Ley Personas Morales de Prueba', 'CACX7605101P8', 'EMPLEADO DE PRUEBA', '-', 'CD13D35E-2FCF-4A23-ADCA-51F2E48B8018', '2014-04-03T18:17:02', '-', 'MUIy85bMjr2K7CLZcj1PnUU3a56KmrqOvF7ubEnaa0beidmPqi7S0YVznA5EKs76c4sJFBGhR73WA47RVNqUFbGdWrd43Mv326SJ+4eRAiJ/2AzAdMX742cxiZ76K9FavCz9sRYkHJLvRkAOk8JewVRWGglEnJLReBr4SX/zGfg=', '-', '2013-11-15', '2014-11-01', '2014-11-15', '15', '0.00', '0.00', '0.00', '0.00', 'A0000000000', '-', 'XEXX010101HNEXXXA4', '00000000000', '2009-06-01', '-', 'Diurna', '1', '9872', 'DPTO', 'ADMIN', '1', '113', '000000000000000000', '228', 'Base', 'Quincenal', '10000.00', '696.80', '-', '0.00', '0.00', '0.00', '13000.00', '379.00', '001', '0.00', '10000.00', '002', '0.00', '1000.00', '-', '-', '-', '004', '0.00', '1000.00', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '019', '10.00', '1000.00', '2', 'Dobles', '3', '153.42', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '029', '379.00', '0.00', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '3332.1', '0.00', '001', '284.39', '002', '2058.71', '-', '-', '-', '-', '-', '-', '-', '-', '300.00', '1', '2', '007', '10.00', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '020', '1004.00', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-']]
    ...
    def test_multi_complements(self):
        sax_handler = CFDI32SAXHandler().use_nomina11()
        cfdi_data = sax_handler.transform_from_file(os.path.dirname(__file__) + '/Resources/nomina11/nom_multi_complements.xml')
        formatter = EfiscoCoreNomina11Formatter(cfdi_data)
