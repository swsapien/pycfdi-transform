...
class TestEfiscoConceptsFormatter(unittest.TestCase):
    ...
    def test_columns_names_concepts(self):
        formatter = EfiscoConceptsDetailFormatter({'cfdi33': {}})
        columns_expected = [
            "VERSION",
            "SERIE",
            "FOLIO",
    ...
    def test_formatter_concept_can_format_ok(self):
        ...
        formatter = EfiscoConceptsDetailFormatter(cfdi_data)
