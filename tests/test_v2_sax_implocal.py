...
class TestHanderCfdi33ImpLocalTests(unittest.TestCase):
    def test_transform_file_implocal(self):
        ...
        self.assertTrue(len(cfdi_data['implocal']) == 1)
        self.assertTrue(cfdi_data['implocal'][0]['total_traslados_impuestos_locales'] == '0.000000')
        self.assertTrue(cfdi_data['implocal'][0]['total_retenciones_impuestos_locales'] == '77.400000')