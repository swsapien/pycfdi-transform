...
class TestEfiscoPagos10Formatter(unittest.TestCase):
    ...
    def test_columns_names_pagos20(self):
        formatter = EfiscoCorpERPPagos20Formatter({'cfdi40': {}})
        columns_expected = [
            "VERSION",
            "SERIE",
            "FOLIO",
    ...
    def test_initialize_class_error_pagos20(self):
        with self.assertRaises(AssertionError) as ex:
            EfiscoCorpERPPagos20Formatter(cfdi_data=None)
    ...
    def test_initialize_class_error_version_pagos20(self):
        with self.assertRaises(AssertionError) as ex:
            EfiscoCorpERPPagos20Formatter({'cfdi33': {}})
    ...
    def test_formatter_error_tfd_pagos20(self):
        ...
        cfdi_data.pop('tfd11')
        formatter = EfiscoCorpERPPagos20Formatter(cfdi_data)
    ...
    def test_rows_pagos20_01_empty_char(self):
        ...
        self.assertIsNotNone(cfdi_data)
        formatter = EfiscoCorpERPPagos20Formatter(cfdi_data, empty_char='-')
        self.assertTrue(formatter.can_format())
        self.assertEqual(formatter.get_errors(), '', 'Errors obtained.')
        row_list = formatter.dict_to_columns()
        end_time = start - time.time()
        first_row = ['4.0','Serie','Folio','2021-12-16T15:40:21','30001000000400002444','0','-','0.0','XXX','-','P','-','-','-','20008','XAXX010101000','PUBLICO GENERAL','601','XAXX010101000','Nombre','G01','080CF54E-F9DB-4470-BF0D-A8613DC10B24','2022-02-08T21:58:56','SPR190613I52','','CP1_P1_DR1','2021-12-02T00:18:10','01','USD','-','14000.00','-','-','-','-','-','-','1488703.81','0.00','1488703.81','2.00','0.00','0.00','2.0','BEDC8964-7E57-4604-9968-7E01378E8706','Serie3','Folio3','MXN','1.329310','','1','5000.00','2000.00','3000.00']
        self.assertListEqual(first_row, row_list[0])
    ...
    def test_rows_pagos20_01_safe_numerics(self):
        ...
        self.assertIsNotNone(cfdi_data)
        formatter = EfiscoCorpERPPagos20Formatter(cfdi_data, safe_numerics=True)
        self.assertTrue(formatter.can_format())
        self.assertEqual(formatter.get_errors(), '', 'Errors obtained.')
        row_list = formatter.dict_to_columns()
        end_time = start - time.time()
        print(row_list[0])
        first_row = ['4.0', 'Serie', 'Folio', '2021-12-16T15:40:21', '30001000000400002444', '0', '0.00', '0.0', 'XXX', '1.00', 'P', '', '', '', '20008', 'XAXX010101000', 'PUBLICO GENERAL', '601', 'XAXX010101000', 'Nombre', 'G01', '080CF54E-F9DB-4470-BF0D-A8613DC10B24', '2022-02-08T21:58:56', 'SPR190613I52', '', 'CP1_P1_DR1', '2021-12-02T00:18:10', '01', 'USD', '1.00', '14000.00', '', '', '', '', '', '', '1488703.81', '0.00', '1488703.81', '2.00', '0.00', '0.00', '2.0', 'BEDC8964-7E57-4604-9968-7E01378E8706', 'Serie3', 'Folio3', 'MXN', '1.329310', '', '1', '5000.00', '2000.00', '3000.00']
        self.assertListEqual(first_row, row_list[0])
        self.assertLess(end_time, 0.01)
    ...
    def test_rows_pagos20_01_empty_char_safe_numerics(self):
        ...
        cfdi_data = sax_handler.transform_from_file(os.path.dirname(__file__) + '/Resources/pagos20/pago_safe_numbers.xml')
        self.assertIsNotNone(cfdi_data)
        formatter = EfiscoCorpERPPagos20Formatter(cfdi_data, empty_char='-', safe_numerics=True)
        self.assertTrue(formatter.can_format())
        self.assertEqual(formatter.get_errors(), '', 'Errors obtained.')
        row_list = formatter.dict_to_columns()
        print(row_list[0])
    ...
    def test_rows_pagos20_impuestos(self):
        ...
        first_row = ['4.0', 'A', '14', '2022-05-30T08:19:02', '30001000000400002335', '0', '0.00', '0', 'XXX', '1.00', 'P', '-', '-', '-', '06370', 'EKU9003173C9', 'ESCUELA KEMPER URGATE', '601', 'URE180429TM6', 'UNIVERSIDAD ROBOTICA ESPAÑOLA', 'CP01', '080CF54E-F9DB-4470-BF0D-A8613DC10B24', '2022-02-08T21:58:56', 'SPR190613I52', '', 'CP1_P1_DR1', '2022-05-26T12:00:00', '03', 'MXN', '1', '98.75', '-', '-', '-', '-', '-', '-', '0.00', '0.00', '0.0', '0.00', '1.25', '0.00', '1.25', 'a0476c1b-8829-448d-82ab-92d8b26be878', 'Serie3', 'Folio3', 'MXN', '1', '', '1', '98.75', '98.75', '0.00']
        self.assertListEqual(first_row, row_list[0])
        self.assertLess(end_time, 0.01)
    ...
    def test_rows_pagos20_multi_tfd(self):
        ...
        for row in row_list:
            self.assertEqual(len(row), len(formatter.get_columns_names()), 'Different length of columns')
        expected_rows = [
                ['4.0', 'Serie', 'Folio', '2022-02-08T00:18:10', '30001000000400002434', '0', '', '0.00', 'XXX', '', 'P', '', '', '', '20000', 'EKU9003173C9', 'ESCUELA KEMPER URGATE SA DE CV', '601', 'URE180429TM6', 'UNIVERSIDAD ROBOTICA ESPAÑOLA SA DE CV', 'G01', '080CF54E-F9DB-4470-BF0D-A8613DC10B24', '2022-02-08T21:58:56', 'SPR190613I52', '', 'CP1_P1_DR1', '2021-12-15T00:00:00', '01', 'MXN', '1', '200.00', '', '', '', '', '', '', '', '', '', '', '', '', '', 'bfc36522-4b8e-45c4-8f14-d11b289f9eb7', '', '', 'MXN', '1', '', '1', '200.00', '200.00', '0.00'],
                ['4.0', 'Serie', 'Folio', '2022-02-08T00:18:10', '30001000000400002434', '0', '', '0.00', 'XXX', '', 'P', '', '', '', '20000', 'EKU9003173C9', 'ESCUELA KEMPER URGATE SA DE CV', '601', 'URE180429TM6', 'UNIVERSIDAD ROBOTICA ESPAÑOLA SA DE CV', 'G01', '080CF54E-F9DB-4470-BF0D-A8613DC10B24', '2022-02-08T21:58:56', 'SPR190613I52', '', 'CP1_P1_DR1', '2021-12-15T00:00:00', '01', 'MXN', '1', '200.00', '', '', '', '', '', '', '', '', '', '', '', '', '', 'bfc36522-4b8e-45c4-8f14-d11b289f9eb7', '', '', 'MXN', '1', '', '1', '200.00', '200.00', '0.00']
            ]
    ...
    def test_rows_pagos20_complete(self):
        ...
        for row in row_list:
            ...
            print(row)
        expected_rows = [
            ['4.0', 'Serie', 'Folio', '2022-02-08T00:18:10', '30001000000400002434', '0', '', '0.00', 'XXX', '', 'P', '', '', '', '20000', 'EKU9003173C9', 'ESCUELA KEMPER URGATE SA DE CV', '601', 'URE180429TM6', 'UNIVERSIDAD ROBOTICA ESPAÑOLA SA DE CV', 'G01', '9D81C696-0401-4F85-B703-6E0D3AFD6057', '2019-03-29T17:42:38', 'AAA010101AAA', '', 'CP1_P1_DR1', '2021-12-15T00:00:00', '01', 'MXN', '1', '200.00', '', '', '', '', '', '', '', '', '', '', '', '', '', 'bfc36522-4b8e-45c4-8f14-d11b289f9eb7', '', '', 'MXN', '1', '', '1', '200.00', '200.00', '0.00']
                    ]
        self.assertListEqual(expected_rows, row_list)