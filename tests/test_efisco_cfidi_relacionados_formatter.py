...
class TestEfiscoCfdiRelacionadosFormatter(unittest.TestCase):
    ...
    def test_formatter_related_cfdi_cfdi33(self):
        ...
        sax_handler = CFDI33SAXHandler().use_related_cfdis()
        cfdi_data = sax_handler.transform_from_file('./tests/Resources/cfdi33/cfdi33_related_cfdis.xml')
        expected_columns = [['1D0EA245-9147-492F-83EF-A7DD8E5D7094','04','48563590-F30B-4EFF-AE15-B2A900000000'],
                            ['1D0EA245-9147-492F-83EF-A7DD8E5D7095','04','48563590-F30B-4EFF-AE15-B2A900000000'],
                            ['1D0EA245-9147-492F-83EF-A7DD8E5D7096','02','48563590-F30B-4EFF-AE15-B2A900000000']
                            ]
        formatter = EfiscoCfdisRelacionadosFormatter(cfdi_data)
    ...
    def test_formatter_related_cfdi_40(self):
        ...
        expected_columns = [
            ['CAAB1AFA-AC0D-BDAC-5CCF-AAD448CAFC08', '08', '9D81C696-0401-4F85-B703-6E0D3AFD6056'],
            ['2EB04CE0-F1ED-3EBC-B796-38FFE2DFEBEC', '08', '9D81C696-0401-4F85-B703-6E0D3AFD6056'],
            ['7FC2BBFD-E7E2-2FAA-39C7-D1DC6CF3FEEE', '08', '9D81C696-0401-4F85-B703-6E0D3AFD6056'],
            ['E06CCA24-CC8E-2AD9-906B-38BACCB5CE2D', '08', '9D81C696-0401-4F85-B703-6E0D3AFD6056']
        ]
        formatter = EfiscoCfdisRelacionadosFormatter(cfdi_data)
        result_columns = formatter.dict_to_columns()
        print(result_columns)
